          ...
          <div className="inner text-center">
            ...
            <nav className="mt-4">
              <ol className="breadcrumb justify-content-center">
                ...
                <li className="breadcrumb-item active" aria-current="page">Kyc policy</li>
              </ol>
            </nav>
          </div>
        </div>
          ...
          <div className="row" >
            <div className="col-md-10 m-auto" >
              <div className="create-item-wrapper plicy_sec" >
                ...
                <h5>1.Risks Relating to Digital Assets</h5>
                ...
                ·Digital Assets are not legal tender and are not backed by the government, or by commodities such as gold or silver. There is no central bank that can take corrective measure to protect the value of Bitcoin and/or Ether and/or any other Digital Assets in a crisis or issue more Digital Assets. Instead, Bitcoin, Ether and any other Digital Assets are autonomous and largely unregulated on worldwide networks. Traders put their trust in a digital, decentralized and partially anonymous system that relies on peer-to-peer networking and cryptography to maintain its integrity.<br/>

                ·Transactions in Digital Assets may be irreversible, and, accordingly, losses due to fraudulent or accidental transactions may not be recoverable;<br/>

                ·Some Digital Asset transactions shall be deemed to be made when recorded on a public ledger, which is not necessarily the date or time that you initiated the transaction;<br/>

                ·The value of Digital Assets may be derived from the continued willingness of market participants to exchange fiat currency or Digital Assets for Digital Assets, which may result in the potential for permanent and total loss of value of a particular Digital Asset should the market for that Digital Asset disappear;<br/>

                ·The nature of Digital Assets may lead to an increased risk of fraud or cyber attack, and may mean that technological difficulties experienced by the Platform may prevent the access to or use of your Digital Assets;<br/>

                ·Trading of Digital Assets is susceptible to irrational (or rational) bubbles or loss of confidence, which could collapse demand relative to supply. For example, confidence might collapse in Bitcoin because of unexpected changes imposed by the software developers or others, a government crackdown, the creation of superior competing alternative cryptocurrencies, or a deflationary or inflationary spiral. Confidence might also collapse if the anonymity of the system is compromised, if money is lost or stolen, or if hackers or governments can prevent any transactions from settling.<br/>

                ·Deposits into your Account is not considered deposits under the applicable laws, rules, or regulations in your jurisdiction.<br/>

                ·Digital Assets in your Account is not subject to applicable deposit insurance protection.</p>

                <h5>2. Risks Relating to Derivatives, Margin and Security/Digital Asset Borrowing</h5>
