          ...
          <div class="d-flex-between mb-5">
            ...
            <div class="d-flex-between bidder">
              ...
              <div class="d-flex-center ms-1">
                ...
                <strong> <span class="text-white"> {stackingDetails?.totalAmount}</span></strong>
              </div>
              <div class="d-flex-between ms-3">
                <span>TOTAL REWARDS: </span>
                <div class="d-flex-center ms-1">
                  <span class="text-white"><strong> {parseFloat(totalRewards / 10 ** 18)} </strong></span>
                </div>
              </div>
            </div>
            ...
            <table class="table">
              <thead >
                <tr>
                  ...
                  <th className="text-end">Stacking Date </th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="text-start">
                    <div class="td_stack justify-content-start div_info">
                      {
                        allStackingBalance.length > 0
                          ? allStackingBalance.map((item) => (

                            <div>
                              <img src="https://api.yugdex.com/uploads/icon/btc.png" class="img-fluid icon_img coinimg " />YUG
                              <div>{/* Yugcoin */} <small></small></div>
                            </div>
                  ...
                  <td className="text-end">
                    <div class="td_stack justify-content-center div_info">
                      {
                        allStackingBalance.length > 0
                          ? allStackingBalance.map((item) => (
                      ...
                      allStackingBalance.length > 0
                        ? allStackingBalance.map((item) => (
                          ...
                          <div className="d-flex align-items-center" >
                            ...
                            <button type="button" class="tb_btn badge  m-0 btn  btn-unstake" onClick={() => unstakeFunction(unStakeIndex)}>
